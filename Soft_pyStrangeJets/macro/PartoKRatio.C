...
void PartoKRatio(){
  ...
  TString sPath[] = {"/home/cuipengyao/study/pythia/Soft_pyStrangeJets/pp13TeV"};
  TString sFile[] = {"AnalysisResults_merged.root"};
  TString sList[] = {"list_results"};
  
  //TString sK[] = {"hKshort_Jet10_C04", "hKshort_Jet10_C04", "hKshort_Jet10_C04"};
  //TString sP[] = {"hLambda_Jet10_C04", "hLambda_Jet10_C04", "hLambda_Jet10_C04"};
  //TString sA[] = {"hAntiLa_Jet10_C04", "hAntiLa_Jet10_C04", "hAntiLa_Jet10_C04"};
 
  TString sK[] = {"hKshort", "hKshort_PCJet10_C04"};
  TString sP[] = {"hLambda", "hLambda_PCJet10_C04"};
  TString sA[] = {"hAntiLa", "hAntiLa_PCJet10_C04"};

  TString sLeg[] = {"Incl", "UE"};
  ...
  TFile *f = TFile::Open("./Data/ParToKRatio_PYTHIA_pp.root", "UPDATE");
  can = MakeCanvas("can");
  ...
  gStyle->SetOptStat("");
  CanvasEnd(can);
  //can->SaveAs(Form("./figure/LKRatio_JE_pPb.eps"));
  return;
}
