...
//=============================================================================
  ...
  tex->DrawLatex(0.16, 0.82, "#frac{#Lambda + #bar{#Lambda}}{2K^{0}_{S}} in jet");
  tex->DrawLatex(0.16, 0.72, "PYTHIA 8");
  can->SaveAs(Form("./figure/16_pPb5d02TeV_Lambda_sum_toKRatio_DataPy_Cone3.eps"));
  can->SaveAs(Form("./figure/16_pPb5d02TeV_Lambda_sum_toKRatio_DataPy_Cone3.pdf"));
  can->SaveAs(Form("./figure/16_pPb5d02TeV_Lambda_sum_toKRatio_DataPy_Cone3.png"));
  CanvasEnd(can);
