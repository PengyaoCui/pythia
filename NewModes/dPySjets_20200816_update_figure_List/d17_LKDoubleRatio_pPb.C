...
void d17_LKDoubleRatio_pPb(){
//=============================================================================

  auto f = TFile::Open("./data/Data/pPb.root", "read");
  TList* l[4]; TH1D *h[4]; TH1D *hE[4]; TH1D *hR[4]; TGraph *gE[4];
  l[0]= (TList*)f->Get(Form("Lambda_sum_toKRatio_0100"));
  l[1]= (TList*)f->Get(Form("Lambda_sum_toKRatio_010"));
  l[2]= (TList*)f->Get(Form("Lambda_sum_toKRatio_1040"));
  l[3]= (TList*)f->Get(Form("Lambda_sum_toKRatio_40100"));
  f->Close();
...
//=============================================================================
  ...
  auto can(MakeCanvas(Form("DoubleRatio")));
  ...
  can->SaveAs(Form("./figure/17_pPb5d02TeV_Lambda_sum_toKRatio_DoubleRatio_Data_Cone3.eps"));
  can->SaveAs(Form("./figure/17_pPb5d02TeV_Lambda_sum_toKRatio_DoubleRatio_Data_Cone3.pdf"));
  can->SaveAs(Form("./figure/17_pPb5d02TeV_Lambda_sum_toKRatio_DoubleRatio_Data_Cone3.png"));
  CanvasEnd(can);
