...
void SpectpPb_MB(TString sType = "Kshort");
void d10_SpectpPb_MB(){
  SpectpPb_MB("Kshort");
  SpectpPb_MB("Lambda_sum");
  SpectpPb_MB("Xi");
  SpectpPb_MB("Omega");
...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/10_pPb5d02TeV_%s_SpectData_Cent0.eps", sType.Data()));
  can->SaveAs(Form("./figure/10_pPb5d02TeV_%s_SpectData_Cent0.pdf", sType.Data()));
  can->SaveAs(Form("./figure/10_pPb5d02TeV_%s_SpectData_Cent0.png", sType.Data()));
  CanvasEnd(can);
