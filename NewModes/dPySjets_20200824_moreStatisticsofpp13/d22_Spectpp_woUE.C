...
void Spectpp_woUE(TString sType = "Kshort");
void d22_Spectpp_woUE(){
  Spectpp_woUE("Kshort");
  Spectpp_woUE("Lambda_sum");
  Spectpp_woUE("Xi");
  Spectpp_woUE("Omega");
...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/22_pp13TeV_%s_SpectData_woUE.eps", sType.Data()));
  can->SaveAs(Form("./figure/22_pp13TeV_%s_SpectData_woUE.pdf", sType.Data()));
  can->SaveAs(Form("./figure/22_pp13TeV_%s_SpectData_woUE.png", sType.Data()));
  CanvasEnd(can);
