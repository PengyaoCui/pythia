...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/15_5d02TeV_%s_toKRatioData_Cent0.eps", sType.Data()));
  can->SaveAs(Form("./figure/15_5d02TeV_%s_toKRatioData_Cent0.pdf", sType.Data()));
  can->SaveAs(Form("./figure/15_5d02TeV_%s_toKRatioData_Cent0.png", sType.Data()));
  CanvasEnd(can);
