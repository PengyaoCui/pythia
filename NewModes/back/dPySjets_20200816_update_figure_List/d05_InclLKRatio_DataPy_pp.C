...
void d05_InclLKRatio_DataPy_pp(){
//=============================================================================
  auto f = TFile::Open("./data/Data/pp.root", "read");
  auto l = (TList*)f->Get(Form("Lambda_sum_toKRatio"));
  f->Close();
  
  auto h = (TH1D*)l->FindObject(Form("hInclR")); auto gE = (TGraphErrors*)l->FindObject(Form("InclRerr"));
...
//=============================================================================
  ...
  tex->DrawLatex(0.16, 0.82, "Inclusive #frac{#Lambda + #bar{#Lambda}}{ 2 K^{0}_{S}}");
  tex->DrawLatex(0.16, 0.72, "PYTHIA 8");
  can->SaveAs(Form("./figure/05_pp13TeV_Lambda_sum_toKRatio_DataPy_Cone0.eps"));
  can->SaveAs(Form("./figure/05_pp13TeV_Lambda_sum_toKRatio_DataPy_Cone0.pdf"));
  can->SaveAs(Form("./figure/05_pp13TeV_Lambda_sum_toKRatio_DataPy_Cone0.png"));
  CanvasEnd(can);
