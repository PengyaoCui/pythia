...
void PartoKRatio_pPb(TString sType = "Lambda_sum", Bool_t IsDiffCone = kTRUE){
//=============================================================================
  ...
  if(sType == "Lambda_sum"){
    for (auto i=0; i<nm; ++i){
      ...
      g[1][i] = new TGraph(RatioLK(i, sd, sj, "JC04", "PC04"));
  ...
  if(sType == "Xi"){
    for (auto i=0; i<nm; ++i){
      ...
      g[1][i] = new TGraph(RatioXK(i, sd, sj, "JC04", "PC04"));
  ...
  if(sType == "Omega"){
    for (auto i=0; i<nm; ++i){
      ...
      g[1][i] = new TGraph(RatioOK(i, sd, sj, "JC04", "PC04"));
