...
void  DrawCones(TString sType = "Kshort");

void dataSpect_pp(TString sType = "Kshort"){
//=============================================================================
...
void  DrawCones(TString sType = "Kshort")
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_SpectData.eps", sType.Data()));
  can->SaveAs(Form("./figure/pp13TeV_%s_SpectData.pdf", sType.Data()));
  can->SaveAs(Form("./figure/pp13TeV_%s_SpectData.png", sType.Data()));
  CanvasEnd(can);
