...
void DataPyPartoLRatio_pp(TString sType = "Omega", Bool_t IsDiffCone = kTRUE){
//=============================================================================
...
void  DrawMode(TString sType = "Omega", Int_t nCone = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toLRatio_DataPy_Cone%d.pdf", sType.Data(), nCone));
...
void  DrawCones(TString sType = "Omega", Int_t nMode = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toLRatio_DataPy_Mode%d.pdf", sType.Data(), nMode));
