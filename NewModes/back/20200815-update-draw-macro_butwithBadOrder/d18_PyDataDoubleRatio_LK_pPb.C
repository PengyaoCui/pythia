...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/d18_pPb5d02TeV_DataPyDoubleRatio_Lambda_sum_toKRatio_Cone3.eps"));
  can->SaveAs(Form("./figure/d18_pPb5d02TeV_DataPyDoubleRatio_Lambda_sum_toKRatio_Cone3.pdf"));
  can->SaveAs(Form("./figure/d18_pPb5d02TeV_DataPyDoubleRatio_Lambda_sum_toKRatio_Cone3.png"));
  CanvasEnd(can);
