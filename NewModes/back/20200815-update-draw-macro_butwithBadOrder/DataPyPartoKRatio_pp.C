...
void DataPyPartoKRatio_pp(TString sType = "Lambda_sum", Bool_t IsDiffCone = kFALSE){
//=============================================================================
...
void  DrawMode(TString sType = "Lambda_sum", Int_t nCone = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Cone%d.eps", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Cone%d.pdf", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Cone%d.png", sType.Data(), nCone));
  CanvasEnd(can);
...
void  DrawCones(TString sType = "Lambda_sum", Int_t nMode = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Mode%d.eps", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Mode%d.pdf", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pp13TeV_%s_toKRatio_DataPy_Mode%d.png", sType.Data(), nMode));
  CanvasEnd(can);
