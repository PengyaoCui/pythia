...
void DataPyPartoXRatio_pp(TString sType = "Omega", Bool_t IsDiffCone = 0){
//=============================================================================
...
void  DrawMode(TString sType = "Omega", Int_t nCone = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Cone%d.eps", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Cone%d.pdf", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Cone%d.png", sType.Data(), nCone));
  CanvasEnd(can);
...
void  DrawCones(TString sType = "Omega", Int_t nMode = 0)
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Mode%d.eps", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Mode%d.pdf", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatio_DataPy_Mode%d.png", sType.Data(), nMode));
  CanvasEnd(can);
