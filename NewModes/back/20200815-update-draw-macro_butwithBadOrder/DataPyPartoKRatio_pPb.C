...
void DataPyPartoKRatio_pPb(TString sType = "Lambda_sum", Bool_t IsDiffCone = kFALSE){
//=============================================================================
  ...
  if(sType == "Lambda_sum"){
    for (auto i=0; i<nm; ++i){
      ...
      g[2][i] = new TGraph(RatioLK(i, sd, sj, "OC08"));
      g[3][i] = new TGraph(RatioLK(i, sd, sj, "JC04", "PC04"));
    }
  }
  if(sType == "Xi"){
    for (auto i=0; i<nm; ++i){
      ...
      g[2][i] = new TGraph(RatioXK(i, sd, sj, "OC08"));
      g[3][i] = new TGraph(RatioXK(i, sd, sj, "JC04", "PC04"));
    }
  }
  ...
  if(sType == "Omega"){
    for (auto i=0; i<nm; ++i){
      ...
      g[2][i] = new TGraph(RatioOK(i, sd, sj, "OC08"));
      g[3][i] = new TGraph(RatioOK(i, sd, sj, "JC04", "PC04"));
    }
  }
...
void  DrawMode(TString sType = "Lambda_sum", Int_t nCone = 0)
{
  ...
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Cone%d.eps", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Cone%d.pdf", sType.Data(), nCone));
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Cone%d.png", sType.Data(), nCone));
  CanvasEnd(can);
...
void  DrawCones(TString sType = "Lambda_sum", Int_t nMode = 0)
{
  ...
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Mode%d.eps", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Mode%d.pdf", sType.Data(), nMode));
  can->SaveAs(Form("./figure/pPb5d02TeV_%s_toKRatio_DataPy_Mode%d.png", sType.Data(), nMode));
  CanvasEnd(can);
