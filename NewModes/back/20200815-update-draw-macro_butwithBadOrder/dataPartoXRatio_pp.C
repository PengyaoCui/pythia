...
void  DrawCones(TString sType = "Omega");

void dataPartoXRatio_pp(TString sType = "Omega"){
//=============================================================================
...
void  DrawCones(TString sType = "Xi")
{
  ...
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatioData.eps", sType.Data()));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatioData.pdf", sType.Data()));
  can->SaveAs(Form("./figure/pp13TeV_%s_toXRatioData.png", sType.Data()));
  CanvasEnd(can);
